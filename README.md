...
| US01                | Registro de usuario                         | Como dueño o trabajador de restaurante, quiero poder crear una cuenta en la plataforma para acceder a sus funcionalidades.                                                                  | Escenario 1: Registro exitoso. Dado que el usuario proporciona datos válidos, cuando envía el formulario de registro, entonces el sistema confirma el registro y permite iniciar sesión.<br>Escenario 2: Registro fallido por correo ya existente. Dado que el usuario usa un correo registrado, cuando intenta enviar el formulario, entonces se muestra un mensaje de error. | E01                      |
| US02                | Inicio de sesión                            | Como dueño o trabajador de restaurante, quiero poder iniciar sesión con mis credenciales para acceder a las funciones específicas según mi rol.                                             | Escenario 1: Inicio exitoso. Dado que el usuario está registrado, cuando envía las credenciales correctas, entonces accede al sistema.<br>Escenario 2: Error por credenciales inválidas. Dado que las credenciales son incorrectas, entonces el sistema muestra un mensaje de error.                                                                                                                              | E01                      |
| US03                | Visualización en tiempo real                | Como dueño de restaurante, quiero ver los datos actuales de sensores IoT para monitorear condiciones del inventario.                                                                         | Escenario 1: Muestra lecturas en tiempo real de temperatura, humedad y gases.<br>Escenario 2: Sensor desconectado muestra advertencia.                                                                                                                                                                                                                                                                                                                                                                                     | E02                      |
| US04                | Configuración de alertas IoT               | Como dueño de restaurante, quiero configurar alertas cuando los valores de los sensores estén fuera del rango ideal.                                                                        | Escenario 1: Sistema genera notificación en app cuando se supera un umbral.                                                                                                                                                                                                                                                                                                                                                                            | E02                      |
| US05                | Registro de productos                      | Como dueño de restaurante, quiero registrar nuevos productos.                                                                   | Escenario 1: Producto agregado correctamente.                                                                                                                                                                                                                                                                                                                                                                                           | E03                      |
| US06                | Consulta de inventario                     | Como dueño de restaurante, quiero consultar el inventario actualizado para tomar decisiones sobre compras y uso.                                                                            | Escenario 1: Muestra lista de productos, fechas de vencimiento, cantidad.<br>Escenario 2: Permite búsqueda por nombre/categoría.                                                                                                                                                                                                                                                                                                                                                                               | E03                      |
| US07                | Alertas de vencimiento                     | Como dueño de restaurante, quiero recibir notificaciones cuando un producto está por vencer.                                                                                                | Escenario 1: Sistema genera alerta X días antes del vencimiento.<br>Escenario 2: Producto vencido aparece resaltado.                                                                                                                                                                                                                                                                                                                                                                                             | E03                      |
| US08                | Solicitud de atención                      | Como cliente del restaurante, quiero presionar un botón para solicitar atención, y que llegue una notificación al personal.                                                                                 | Escenario 1: Botón presionado activa notificación.<br>Escenario 2: Personal recibe alerta en dashboard o app móvil.                                                                                                                                                                                                                                                                                                                                                                                               | E04                      |
| US09                | Registro de tiempo de respuesta            | Como administrador, quiero medir cuánto tiempo tarda el personal en atender una solicitud para evaluar el servicio.                                                                          | Escenario 1: Se registra timestamp de solicitud y atención.<br>Escenario 2: Se genera reporte de eficiencia.                                                                                                                                                                                                                                                                                                                                                                                                    | E04                      |
| TS01                | Endpoint de Registro                        | Como desarrollador, quiero crear el endpoint POST /api/v1/users/register para permitir a nuevos usuarios registrarse en la plataforma.                                                       | Escenario 1: Registro exitoso devuelve status 201.<br>Escenario 2: Registro con email duplicado devuelve status 400 con mensaje de error.                                                                                                                                                                                                                                                                                                                                                                      | E01                      |
| TS02                | Endpoint de Autenticación                   | Como desarrollador, quiero crear el endpoint POST /api/v1/users/login para autenticar a los usuarios y devolver un token.                                                                   | Escenario 1: Autenticación válida devuelve status 200 y token.<br>Escenario 2: Credenciales inválidas devuelve status 401 con mensaje de error.                                                                                                                                                                                                                                                                                                                                                                  | E01                      |
| TS03                | Endpoint de datos en tiempo real           | Como desarrollador, quiero implementar WebSocket o polling en /api/v1/sensors/live para actualizar lecturas en tiempo real.                                                                 | Escenario 1: Conexión activa transmite lecturas cada X segundos.<br>Escenario 2: Error de red lanza mensaje de reconexión.                                                                                                                                                                                                                                                                                                                                                                                         | E02                      |
| TS04                | Endpoint de configuración de alertas       | Como desarrollador, quiero crear el endpoint POST /api/v1/alerts para guardar configuraciones personalizadas de alertas.                                                                    | Escenario 1: Umbrales válidos se guardan correctamente (status 201).<br>Escenario 2: Faltan campos y retorna error 400.                                                                                                                                                                                                                                                                                                                                                                                       | E02                      |
| TS05                | Endpoints CRUD de inventario               | Como desarrollador, quiero implementar endpoints para crear, leer, actualizar y eliminar productos (/api/v1/inventory).                                                                     | Escenario 1: CRUD responde con códigos 200/201/204.<br>Escenario 2: Validaciones de cantidad, fechas y duplicados.                                                                                                                                                                                                                                                                                                                                                                                              | E03                      |
| TS06                | Lógica de notificaciones de vencimiento    | Como desarrollador, quiero una tarea programada (cronjob) que revise fechas de caducidad y envíe alertas.                                                                                    | Escenario 1: Se ejecuta diariamente y notifica productos próximos a vencer.<br>Escenario 2: Error en tarea se loguea.                                                                                                                                                                                                                                                                                                                                                                                            | E03                      |
| TS07                | Integración con botones IoT                | Como desarrollador, quiero integrar dispositivos IoT con el backend para recibir eventos al presionar el botón.                                                                             | Escenario 1: El evento POST llega al endpoint /api/v1/iot/call-button.<br>Escenario 2: Sistema almacena solicitud y envía notificación.                                                                                                                                                                                                                                                                                                                                                                         | E04                      |
| TS08                | Visualización de solicitudes pendientes    | Como desarrollador, quiero mostrar en tiempo real en un panel las solicitudes de atención pendientes.                                                                                        | Escenario 1: Dashboard muestra solicitudes en orden cronológico.<br>Escenario 2: Solicitudes atendidas se marcan como completadas.                                                                                                                                                                                                                                                                                                                                                                             | E04                      |
